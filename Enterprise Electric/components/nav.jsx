      ...
      <div className="container">
        <div className="nav-inner">
          ...
          <button className="nav-mobile-toggle" onClick={() => setOpen((o) => !o)} aria-label="Menu">
            <svg width="18" height="14" viewBox="0 0 18 14" fill="none"><path d={open ? "M2 2 L16 12 M16 2 L2 12" : "M0 1 H18 M0 7 H18 M0 13 H18"} stroke="currentColor" strokeWidth="1.5" /></svg>
          </button>
        </div>
      </div>
      {open && (
      ...
      <div className="container">
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 24, flexWrap: "wrap" }}>
            <a href="tel:5154327162" className="btn btn-primary btn-arrow">(515) 432-7162</a>
            <a href="#/contact" className="btn btn-ghost" style={{ color: "#fff", borderColor: "#ffffff33" }}>Request a quote</a>
          </div>
        </div>
