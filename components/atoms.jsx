...
function PhotoTile({ photo, className, onClick, showNum }) {
  const style = photo.src
    ? { backgroundImage: `url(${photo.src})`, backgroundSize: "cover", backgroundPosition: "center" }
    : undefined;
  return (
    <div className={`gallery-tile ${className || ""}`} onClick={onClick} role="button" tabIndex={0}>
  ...
  return (
    <div className="lb" onClick={onClose}>
      ...
      <div className="lb-body" onClick={(e) => e.stopPropagation()}>
        <div className="lb-img" style={style}>
        ...
        <div className="lb-meta">
          ...
          <div style={{ display:"flex", gap: 12, marginTop: 24 }}>
            <button className="btn btn-primary btn-arrow" onClick={(e) => { e.stopPropagation(); onNext(); }}>Next project</button>
          </div>
        </div>
      </div>
